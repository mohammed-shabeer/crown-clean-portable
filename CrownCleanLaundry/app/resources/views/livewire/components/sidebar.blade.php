<aside class="sidebar">
    ...
    <div>
        <a href="#" class="sidebar-logo">
            ...
            <img src="{{ asset('assets/images/laundry_icon.png') }}" alt="site logo" class="logo-icon">
        </a>
    </div>
        ...
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    ...
                    @can('setting_view')
                    <li>
                        <a href="{{ route('settings.print-settings') }}"><i
                                class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> {{$lang->data['print_settings'] ?? 'Print Settings'}}</a>
                    </li>
                    @endcan
                    @can('setting_theme')
                    <li>
