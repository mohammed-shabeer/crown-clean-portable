            ...
            <div class="card-header tw-flex tw-items-center tw-justify-between border-bottom bg-base px-24 d-flex  flex-wrap gap-3 justify-content-between ">
                ...
                <div class="tw-flex tw-flex-col  tw-text-sm tw-items-end">
                    ...
                    <div class="tw-flex tw-flex-col tw-mt-2 tw-items-end">
                        <div class="text-neutral-600" style="font-size: 18px;">
                            {{ $lang->data['order_id'] ?? 'Order ID' }} : <span class="tw-font-bold text-primary-light" style="font-size: 22px;">#{{ $order->order_number }}</span> 
                        </div>
                        <div class="text-neutral-600">
                            {{ $lang->data['order_date'] ?? 'Order Date' }} : <span class="tw-font-medium text-primary-light">{{ \Carbon\Carbon::parse($order->order_date)->format('l, d/m/Y') }}</span> 
                        </div>
                        <div class="text-neutral-600">
                            {{ $lang->data['order_time'] ?? 'Time' }} : <span class="tw-font-medium text-primary-light">{{ \Carbon\Carbon::parse($order->order_date)->format('h:i A') }}</span> 
                        </div>
                        <div class="text-neutral-600">
                            {{ $lang->data['delivery_date'] ?? 'Delivery Date' }} : <span class="tw-font-medium text-primary-light">{{ \Carbon\Carbon::parse($order->delivery_date)->format('l, d/m/Y') }}</span> 
                        </div>
                    ...
                    <table class="table bordered-table sm-table mb-0 tw-w-full">
                      ...
                      <tbody>
                        @foreach ($orderdetails as $item)
                            ...
                            @endphp
                            <tr class="tw-text-sm tw-font-semibold">
                                <td>
                                    {{ $loop->index + 1 }}
                                </td>
                                <td class="">
                                    <div class="tw-flex tw-gap-4">
                                        ...
                                        <div class="tw-flex tw-flex-col">
                                            <p class="tw-font-bold">{{ $service->service_name }}</p>
                                            <p class="text-info tw-font-bold">[{{$item->service_name}}]</p>
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="tw-flex tw-flex-col">
                    ...
                    <div class="tw-flex tw-justify-between tw-items-start @if(count($orderaddons) <= 0) tw-mt-6 @endif">
                        <div class="tw-flex tw-flex-col ">
                            ...
                            <div class="tw-text-sm" style="font-size: 16px; font-weight: bold;">
                ...
                <div class="invoice-details" style="border-top:none;">
                    <div class="invoice-list">
                        ...
                        <div class="text-center">
                            <h4 class="heading font-bold" style="font-size: 25px">{{ $lang->data['receipt'] ?? 'Receipt' }}</h4>
                        ...
                        <div class="row-data" style="border:none; margin-bottom: 1px">
                            <div class="item-info">
                                <h5 class="item-title" style="font-size: 18px;"><b>{{ $lang->data['order_no'] ?? 'Order No' }}</b></h5>
                            </div>
                            <h5 class="my-5" style="font-size: 22px; font-weight: bold;"><b>#{{ $order->order_number }}</b></h5>
                        </div>
                        <div class="row-data" style="border:none;">
                            ...
                            <h5 class="my-5">
                                <b>{{ \Carbon\Carbon::parse($order->order_date)->format('h:i A') }}</b><br>
                                <b>{{ \Carbon\Carbon::parse($order->order_date)->format('l, d/m/Y') }}</b>
                            </h5>
                        </div>
                        <div class="row-data" style="border:none;">
                            <div class="item-info">
                        ...
                        <div class="row-data" style="text-align: center;margin-top: 5px; padding-bottom: 8px; align-items: center;">
                            <div class="item-info" style="width: 82px;text-align: initial;">
                                ...
                                <h5 class="item-title" style="font-weight: normal;">{{ $service->service_name }}</h5>
                                <h5 class="item-title" style="font-weight: normal;">[{{ $item->service_name }}]</h5>
                            </div>
                            ...
                            <h5 class="my-5" style="font-weight: normal;">{{ getFormattedCurrency($item->service_price) }}</h5>
                            <h5 class="my-5" style="font-weight: normal;">{{ $item->service_quantity }}</h5>
                            <h5 class="my-5" style="font-weight: normal;">{{ getFormattedCurrency($item->service_detail_total) }}</h5>
                        </div>
                        @endforeach
                        @php
                        ...
                        <div class="row-data" style="text-align: center;margin-top: 5px; padding-bottom: 8px;">
                            <h5 class="my-5" style="text-align: initial; width: 82px; font-weight: normal;">
                                {{ $row->addon_name }}
                            </h5>
                            <h5 class="my-5" style="font-weight: normal;">-</h5>
                            <h5 class="my-5" style="font-weight: normal;">-</h5>
                            <h5 class="my-5" style="font-weight: normal;">{{ getFormattedCurrency($row->addon_price) }}
                            </h5>
                        </div>
                        @endforeach
                        @endif
                    ...
                    <div class="invoice-footer mb-15">
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title"><b>{{ $lang->data['tax'] ?? 'Tax' }}
                                    ({{ $order->tax_percentage }}%):</b></h5>
                            </div>
                            <h5 class="my-5"><b>{{ getFormattedCurrency($order->tax_amount) }}</b></h5>
                        </div>
                        @endif
                        @if($printSettings['show_gross_total'])
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title"><b>{{ $lang->data['gross_total'] ?? 'Gross Total' }}:</b>
                                </h5>
                            </div>
                            <h5 class="my-5"><b>{{ getFormattedCurrency($order->total) }}</b>
                            </h5>
                        </div>
                        @endif
                        <div class="row-data">
                            <div class="item-info">
                                ...
                                @endphp
                                <h5 class="item-title"><b>{{ $lang->data['paid_amount'] ?? 'Paid Amount' }}:</b>
                                </h5>
                            </div>
                            <h5 class="my-5"><b>{{ getFormattedCurrency($current_paid_amount) }}</b>
                            </h5>
                        </div>
                        @php
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title"><b>{{ $lang->data['invoice_balance'] ?? 'Invoice Balance' }}:</b>
                                </h5>
                            </div>
                            <h5 class="my-5">
                                <b>{{ getFormattedCurrency($order->total - $received_amount)}}</b>
                            </h5>
                        </div>
                        @endif
                        @if($customer)
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title"><b>{{ $lang->data['customer_balance'] ?? 'Customer Balance' }}:</b>
                                </h5>
                            </div>
                            <h5 class="my-5">
                                <b>@if ($inline_balance < 0) {{ getFormattedCurrency($inline_balance * -1) }} {{ 'Cr' }} @else {{ getFormattedCurrency($inline_balance) }} {{ 'Dr' }} @endif</b> </h5>
                        </div>
                        @endif
                        @endif
                        <hr>
            ...
            <div class="invoice-card">
                ...
                <div class="invoice-details" style="border-top:none;">
                    <div class="invoice-list">
                        ...
                        <div class="row-data" style="text-align: center;margin-top: 5px; padding-bottom: 8px; align-items: center">
                            <div class="item-info" style="width: 82px;text-align: initial;">
                                ...
                                <h5 class="item-title">{{ $service->service_name }}</h5>
                                <h5 class="item-title">[{{ $item->service_name }}]</h5>
                            </div>
                            {{-- <h5 class="my-5"><b><img src="{{asset('assets/img/service-icons/'.$service->icon)}}" class="avatar avatar-sm me-3 d-flex px-3 py-1" height="25" width="35"></b></h5> --}}
                            <h5 class="my-5">{{ getFormattedCurrency($item->service_price) }}</h5>
                            <h5 class="my-5">{{ $item->service_quantity }}</h5>
                            <h5 class="my-5">{{ getFormattedCurrency($item->service_detail_total) }}
                            </h5>
                        </div>
                        @endforeach
                        @php
                        ...
                        <div class="row-data" style="text-align: center;margin-top: 5px; padding-bottom: 8px;">
                            ...
                            <h5 class="my-5 ">-</h5>
                            <h5 class="my-5">-</h5>
                            <h5 class="my-5">{{ getFormattedCurrency($row->addon_price) }}
                            </h5>
                        </div>
                        @endforeach
                        @endif
                    ...
                    <div class="invoice-footer mb-15">
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title"><b>{{ $lang->data['sub_total'] ?? 'Sub Total' }}:</b></h5>
                            </div>
                            <h5 class="my-5"><b>{{ getFormattedCurrency($order->sub_total) }}</b></h5>
                        </div>
                        @endif
                        @if($printSettings['show_addon'] && $order->addon_total > 0)
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title"><b>{{ $lang->data['addon'] ?? 'Addon' }}:</b></h5>
                            </div>
                            <h5 class="my-5">
                                <b>{{ getFormattedCurrency($order->addon_total) }}</b>
                            </h5>
                        </div>
                        @endif
                        @if($printSettings['show_discount'] && $order->discount > 0)
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title"><b>{{ $lang->data['discount'] ?? 'Discount' }}:</b></h5>
                            </div>
                            <h5 class="my-5"><b>{{ getFormattedCurrency($order->discount) }}</b></h5>
                        </div>
                        @endif
                        @if($order->tax_type==2)
                        <div class="row-data">
                ...
                <div class="invoice-details" style="border-top:none;margin-top : 0;">
                    <div class="invoice-list">
                        ...
                        <div class="row-data" style="text-align: center;margin-top: 5px; padding-bottom: 8px; align-items: center">
                            ...
                            <h5 class="my-5">{{ $item->service_quantity }}</h5>
                            <h5 class="my-5">{{ ($item->service_detail_total) }}
                            </h5>
                        </div>
                        @endforeach
                        @php
                    ...
                    <div class="invoice-footer mb-15">
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title text-bold">{{ $lang->data['sub_total'] ?? 'Sub Total' }}:</h5>
                            </div>
                            <h5 class="my-0 text-bold">{{ ($order->sub_total) }}</h5>
                        </div>
                        @endif
                        @if($printSettings['show_addon'] && $order->addon_total > 0)
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title text-bold">{{ $lang->data['addon'] ?? 'Addon' }}:</h5>
                            </div>
                            <h5 class="my-0 text-bold">
                                {{ ($order->addon_total) }}
                            </h5>
                        </div>
                        @endif
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title text-bold">{{ $lang->data['discount'] ?? 'Discount' }}:</h5>
                            </div>
                            <h5 class="my-0 text-bold">{{ ($order->discount) }}</h5>
                        </div>
                        @endif
                        @if($order->tax_type==2)
                        <div class="row-data">
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title text-bold">{{ $lang->data['tax'] ?? 'Tax' }}
                                    ({{ $order->tax_percentage }}%):</h5>
                            </div>
                            <h5 class="my-0 text-bold">{{ ($order->tax_amount) }}</h5>
                        </div>
                        @endif
                        @if($printSettings['show_gross_total'])
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title text-bold">{{ $lang->data['gross_total'] ?? 'Gross Total' }}:
                                </h5>
                            </div>
                            <h5 class="my-0 text-bold">{{ ($order->total) }}
                            </h5>
                        </div>
                        @endif
                        <div class="row-data">
                            <div class="item-info">
                                ...
                                $current_paid_amount = \App\Models\Payment::where('order_id', $order->id)->sum('received_amount');
                                @endphp
                                <h5 class="item-title text-bold">{{ $lang->data['paid_amount'] ?? 'Paid Amount' }}:
                                </h5>
                            </div>
                            <h5 class="my-0 text-bold">{{ ($current_paid_amount) }}
                            </h5>
                        </div>
                        @php
                        $received_payment_row = \App\Models\Payment::where('order_id', $order->id)->sum('received_amount');
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title text-bold">{{ $lang->data['invoice_balance'] ?? 'Invoice Balance' }}:
                                </h5>
                            </div>
                            <h5 class="my-0 text-bold">
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <h5 class="item-title text-bold">{{ $lang->data['customer_balance'] ?? 'Customer Balance' }}:
                                </h5>
                            </div>
                            <h5 class="my-0 text-bold">
...
<script type="text/javascript">
    ...
    // Printer configuration from app settings
    const printerConfig = {!! getPrintJSConfig() !!};
    
    // Print manager class for handling all print operations
    class PrintManager {
        constructor(config) {
            this.config = config;
            this.printCount = 0;
            this.totalCopies = config.copies || 1;
        }
        
        // Execute print based on configuration
        executePrint() {
            if (this.config.auto_print) {
                // Auto print mode - prints directly without dialog
                this.silentPrint();
            } else {
                // Normal print mode - shows print dialog
                this.normalPrint();
            }
        }
        
        // Silent print (no dialog) - Note: Browser limitations apply
        silentPrint() {
            // For multiple copies in auto mode
            this.printWithCopies();
        }
        
        // Normal print with dialog
        normalPrint() {
            window.print();
            this.handlePostPrint();
        }
        
        // Print multiple copies
        printWithCopies() {
            const printCopy = () => {
                if (this.printCount < this.totalCopies) {
                    this.printCount++;
                    window.print();
                    
                    // For multiple copies, we rely on the browser's handling
                    // Most modern browsers can handle multiple copies in print dialog
                    if (this.printCount >= this.totalCopies) {
                        this.handlePostPrint();
                    }
                }
        ...
        handlePostPrint() {
            // Close window after printing or when focus returns
            ...
            // Fallback: close after a delay if afterprint event fires
    ...
    // Initialize and execute print on page load
    window.onload = function() {
        const printManager = new PrintManager(printerConfig);
        
        // Small delay to ensure content is fully rendered
        setTimeout(() => {
            printManager.executePrint();
        }, 300);
    };
</script>