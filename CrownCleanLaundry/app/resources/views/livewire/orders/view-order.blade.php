                                ...
                                <div class="col-12">
                                    <div class="">
                                        <ul>
                                            ...
                                            <li class="d-flex align-items-center gap-1 mb-12 tw-justify-between">
                                                <span class="text-md fw-semibold text-primary-light">{{ $lang->data['sub_total'] ?? 'Sub Total' }} :</span>
                                                <span class="text-secondary-light fw-medium">{{ getFormattedCurrency($sub_total) }}</span>
                                            </li>
                                            <li class="d-flex align-items-center gap-1 mb-12 tw-justify-between">
                                                <span class="text-md fw-semibold text-primary-light">{{ $lang->data['discount'] ?? 'Discount' }} :</span>
                                                <input type="number" step="0.001" min="0" wire:model.live="modal_discount" 
                                                     class="form-control tw-w-24 tw-text-right tw-py-1 tw-px-2" 
                                                     placeholder="0.000">
                                            </li>
                                            <li class="d-flex align-items-center gap-1 mb-12 tw-justify-between">
                                                <span class="text-md fw-semibold text-primary-light"> {{ $lang->data['order_amount'] ?? 'Order Amount' }} :</span>
                                                <span class="text-secondary-light fw-medium"> {{ getFormattedCurrency($this->calculatedTotal) }}</span>
                                            </li>
                                            <li class="d-flex align-items-center gap-1 mb-12 tw-justify-between">
                                            ...
                                            <li class="d-flex align-items-center gap-1 tw-justify-between">
                                                ...
                                                <span class="text-secondary-light fw-medium"> {{ getFormattedCurrency($this->calculatedTotal - $paid_amount) }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
